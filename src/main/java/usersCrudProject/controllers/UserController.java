package usersCrudProject.controllers;
...
import usersCrudProject.dao.UsersInterface;
...
public class UserController {
    ...
    @Autowired
    public UserController(@Qualifier("usersClass") UsersInterface usersDAO) {this.usersDAO = usersDAO;}
